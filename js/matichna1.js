...
function goToLogin(){
 ...
 function first(){
    document.getElementById("image").setAttribute("src", "sliki/matichni/matichna1.jpg");
 }
 function second(){
    document.getElementById("image").setAttribute("src", "sliki/matichni/matichna1v1.jpg");
 }
